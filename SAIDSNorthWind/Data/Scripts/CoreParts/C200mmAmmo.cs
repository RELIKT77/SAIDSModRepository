    ...
    partial class Parts
    {
        private AmmoDef C200mmAmmo => new AmmoDef
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                HealthHitModifier = 8, // defaults to a value of 1, this setting modifies how much Health is subtracted from a projectile per hit (1 = per hit).
        ...
        private AmmoDef C200mmAmmoImpact => new AmmoDef
        {
            AmmoMagazine = "RedAmmoMagDef",
            AmmoRound = "HE203mm",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef C200mmAmmoAP => new AmmoDef
        {
            AmmoMagazine = "RedAmmoMagDef",
            AmmoRound = "AP203mm",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef C200mmShrapnel => new AmmoDef
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // true = voxels are vulnerable to this weapon
                SelfDamage = false, // true = allow self damage.
                HealthHitModifier = 32, // defaults to a value of 1, this setting modifies how much Health is subtracted from a projectile per hit (1 = per hit).
                // modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01 = 1% damage, 2 = 200% damage.
                Characters = -1f,
                VoxelHitModifier = 10,					
				FallOff = new FallOffDef
          ...
          private AmmoDef C200mmShrapnelbase => new AmmoDef
        {
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                DamageVoxels = false, // true = voxels are vulnerable to this weapon
                SelfDamage = false, // true = allow self damage.
                HealthHitModifier = 28, // defaults to a value of 1, this setting modifies how much Health is subtracted from a projectile per hit (1 = per hit).
                // modifier values: -1 = disabled (higher performance), 0 = no damage, 0.01 = 1% damage, 2 = 200% damage.
                VoxelHitModifier = 10,				
                Characters = -1f,
				FallOff = new FallOffDef
          ...
          private AmmoDef C200mmAPHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "C200mmAPHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
          ...
          private AmmoDef C200mmPDAOE => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "C200mmPDAOE",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
