...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef C300mmAmmoAP => new AmmoDef
        {
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 2000, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                AccelPerSec = 0f,
                DesiredSpeed = 1000,
        ...
        private AmmoDef C300mmAmmoHE => new AmmoDef
        {
            AmmoMagazine = "RedAmmoMagDef",
            AmmoRound = "C300HE",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
        ...
        private AmmoDef C300mmAmmoG => new AmmoDef
        {
            AmmoMagazine = "RedAmmoMagDef",
            AmmoRound = "C300G",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 0.1f,
                        Color = Color(red: 15.80f, green: 15.20f, blue: 20.0f, alpha: 0.8f),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
                        Material = "WeaponLaser",
                        DecayTime = 20,
                        Color = Color(red: 3.585f, green: 3.562f, blue: 4.21f, alpha: 0.5f),
                        Back = false,
                        CustomWidth = 0.1f,
                        UseWidthVariance = false,
                        UseColorFade = true,
        ...
        private AmmoDef C300mmShrapnel => new AmmoDef
        {
            AmmoMagazine = "",
          ...
          private AmmoDef C300GSecond => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "C300GSecond",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
          ...
          private AmmoDef C300mmAPHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "C300mmAPHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
          ...
          private AmmoDef C300mmHEShrapbase => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "C300mmHEShrapbase",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
